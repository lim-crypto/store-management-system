            ...
            <div class="invoice p-3 mb-3">
                ...
                <div class="row">
                    <div class="col-sm-5 invoice-col">
                        ...
                        <address>
                            ...
                            <br> Contact: {{$order->user->contact_number}}
                        </address>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row no-print">
                    <div class="col-12">
                        ...
                        <a href="{{route('orders.print',$order->id)}}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
