                        ...
                        <form action="{{route('services.store')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="service" id="service" placeholder="Service" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="description" required></textarea>
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="offers-container">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group ">
                                            <input type="text" class="form-control offers" name="offer[]" multiple="multiple" required placeholder="Offer">
                                            <input type="number" step="any" class="form-control price" name="price[]" multiple="multiple" required placeholder="Price">
