                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" placeholder="Enter Name" required value="{{old('name')}}">
                                            <span class="invalid-feedback" role="alert">
                                                Name is required
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label> Birthday </label> <span class="text-danger">*</span> <span class="text-info small">mm/dd/yyyy</span>
                                            <div class="input-group date" id="birthday" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input  {{ $errors->has('birthday') ? ' is-invalid' : '' }}" name="birthday" data-target="#birthday" data-toggle="datetimepicker" placeholder="Enter Birthday" required value="{{old('birthday') ? date('m/d/Y', strtotime(old('birthday'))): '' }}" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" min="0" class="form-control {{ $errors->has('weight') ? ' is-invalid' : '' }}" id="weight" name="weight" placeholder="Enter Weight" required value="{{old('weight')}}">
                                            <span class="invalid-feedback" role="alert">
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" min="0" class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" id="price" name="price" placeholder="Enter Price" value="{{old('price')}}">
                                            <span class="invalid-feedback" role="alert">
                                                Price is required
                                            </span>
                                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="images[]" class="custom-file-input  {{ $errors->has('images.*') ? ' is-invalid' : ($errors->has('images')?' is-invalid':'') }}" id="gallery-photo-add" multiple accept="image/*" required>
            ...
            if (input.files) {
                ...
                for (i = 0; i < filesAmount; i++) {
                    ...
                    reader.onload = function(event) {
                        ...
                        $('<a href="' + event.target.result + '" data-toggle="lightbox" data-gallery="gallery">').addClass('w-100 col-sm-4  ')
